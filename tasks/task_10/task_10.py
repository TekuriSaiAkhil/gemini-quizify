        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                if submitted:
                    ...
                    ##### YOUR CODE HERE #####
                    generator = QuizGenerator(topic=topic_input, num_questions=questions, vectorstore=chroma_creator) # Step 3: Initialize a QuizGenerator class using the topic, number of questrions, and the chroma collection

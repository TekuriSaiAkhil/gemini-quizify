...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        chromaDB = ChromaCollectionCreator(processor, embeddings)
        ...
        with st.form("Load Data to Chroma"):
            ...
            ####### YOUR CODE HERE #######
            user_query = st.text_input("Topic for generative quiz", placeholder="Enter the topic of the document",)
            num_questions = st.slider("Number of Questions", 0, 10, 5)
            ...
            if submitted:
                ...
                ####### YOUR CODE HERE #######
                chromaDB.create_chroma_collection()
                    
                # Uncomment the following lines to test the query_chroma_collection() method
                document = chromaDB.query_chroma_collection(user_query) 
